...
#xPos <- function(
#			mod,			## model to be simulated for evaluation: Deb test functions{1,2,3,4}, apsim{10}, apsimInKatherine{11}, apsimInUFS{12}, apsimInWC{13}
...
#xPos(13,2,0,8,1000000,1000000,log=FALSE,seed=NULL)
xPos(13,2,2,4,100,300,log=FALSE,seed=NULL)
# 604800 secs = 1 week
