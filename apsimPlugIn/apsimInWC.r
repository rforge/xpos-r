...
##################################
	simTemplate <- "winterWheat_autoIrrig-template.sim"
##################################
...
##################################
	metFileName <- "0041347_A_gfdl_co.met";
##################################
...
##################################
	...
	perDef <- array(c(
##################################
	1965,		# min year that you want to use as randomness
...
#	if text needed (work with one only for now)
	textDec1<-c("12-apr","19-apr","26-apr",
			"03-may","10-may","17-may","24-may","31-may",
			"07-jun","14-jun");
#     otherwise
#	textDec1 <- NULL;
##################################
